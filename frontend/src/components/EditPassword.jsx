...
import { isValidPassword, apiCall } from '../helpers/helper'
import { invalidPasswordErrorMessage, nonMatchingPasswordErrorMessage } from '../constants/constants';
...
export default function ResetPassword() {
    ...
    const onSubmit = async () => {
        const requestData = {
            currentPassword : accountDetail.currentPassword,
            newPassword: accountDetail.newPassword,
        }

        const response = await apiCall('PUT', '/auth/passwordreset', requestData)
    ...
    const handleSubmit = (e) => {
        ...
        if (isValidPassword(accountDetail.newPassword)) {
            ...
            // alert(invalidPasswordErrorMessage)
            setErrorAlert(invalidPasswordErrorMessage)
        }
    }
    ...
    return (
        ...
        <div className='central-card'>
            <form className='edit-form' onSubmit={handleSubmit} style={{borderRadius: '20px' }}>
              ...
              <AuthTextField type="password" onChange={inputChange} name="currentPassword" label="Current Password" value={accountDetail.currentPassword}/>
